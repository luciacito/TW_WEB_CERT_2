...
<?php include_once("doula.php");?>
<div style="width:630px;min-height:320px;margin:0 auto;">
  <fieldset class="mm mm_noselect" id = "aa1" onclick="opmenu('a1');">健康新知</fieldset>
  <fieldset class="mm mm_noselect" id = "aa2" onclick="opmenu('a2');">菸害防治</fieldset>
  <fieldset class="mm mm_noselect" id = "aa3" onclick="opmenu('a3');">癌症防治</fieldset>
  <fieldset class="mm mm_noselect" id = "aa4" onclick="opmenu('a4');">慢性病防治</fieldset>
  <fieldset id="apple">
    <span id="a1" class="apple">
...
<script>
 function opmenu(xx){
  clmenu();
  $("#a"+xx).attr("class","mm mm_inselect");
  $("#"+xx).show();
 }
 function clmenu(){
  $("fieldset").attr("class","mm mm_noselect");
  $("#apple").attr("class","");
  $(".apple").hide();
 }
 opmenu("a1");
