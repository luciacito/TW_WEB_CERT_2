...
<iframe name="back" style="display:none;"></iframe>
	<div id="all">
    	<div id="title">
        <?=$now_month?> 月 <?=$now_day?> 號 <?=$now_week?> | 今日瀏覽: <?=$today_cnt?> | 累積瀏覽: <?=$totle_cnt?>  <a href = "/"><div style="float:right;">回首頁</div></a></div>
        <div id="title2">
<img src="images/02B01.jpg" title = "健康促進網-回首頁" alt = "健康促進網-回首頁">
        </div>
        <div id="mm">
